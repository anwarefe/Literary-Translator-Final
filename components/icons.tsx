...
export const TranslateIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg 
        ...
        strokeWidth={2}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 5h12M9 3v2m4.25 16l-4.25-4.25M19.5 12c0-4.638-3.5-8.25-8.25-8.25S3 7.362 3 12c0 4.638 3.5 8.25 8.25 8.25s8.25-3.612 8.25-8.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 009-9c0-4.968-4.032-9-9-9s-9 4.032-9 9c0 4.968 4.032 9 9 9zM19 12a7 7 0 11-14 0 7 7 0 0114 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.5 10.5h-7M15.5 13.5h-7" />
    </svg>
);
